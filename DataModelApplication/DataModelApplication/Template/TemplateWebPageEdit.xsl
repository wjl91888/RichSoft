...
<xsl:template match="/">
<![CDATA[
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="]]><xsl:value-of select="/NewDataSet/TableName"/><![CDATA[Edit.aspx.cs"
    Inherits="Administrator_]]><xsl:value-of select="/NewDataSet/TableName"/><![CDATA[Edit" %>
                ...
                <tr>
                    <td class="hback" colspan="2">
                        <div style="text-align: center; width: 100%">
                            <asp:Button ID="btnModify" Text="确认修改信息" runat="server" OnClick="btnModify_Click" />
